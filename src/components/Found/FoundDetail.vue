      ...
      <div class="detail-div">
        <el-card :span="8" class="detail-card">
            ...
            <el-row style="margin-left:600px;">
                ...
                <el-tag type="danger" style="width:150px;height:45px;padding-top:5px;font-weight: bolder;font-size:17px" closable>{{detailarr.zhaolingtime  | formatDate}}</el-tag>
            </el-row>
            <el-row>
                <el-col :span="11">
                  <img :src="detailarr.zhaolingpic" class="foundimage">
                </el-col>
                <el-col :span="9">
                    <div class="intro-div">
                        <h4>详细介绍：</h4>
                        <p>{{detailarr.zhaolingcont}}</p>
                    </div>
                </el-col>
            </el-row>
            ...
            <el-row class="detail-class">
                ...
                <el-col :span="7" class="detail-txt"><p>{{detailarr.lostcity}}{{detailarr.zhaolingplace}}</p></el-col>
            </el-row>
            <el-row class="detail-class">
                <el-col :span="2"><h4>拾捡时间：</h4></el-col>
                <el-col :span="7" class="detail-txt"><p>{{detailarr.zhaolingtime | formatDate}}</p></el-col>
            </el-row>
            <el-row class="detail-class">
  ...
  created () {
    ...
    this.$axios.get('http://192.168.43.126:3000/zhaoling')
      .then(function (response) {
        ...
        console.log(response.data[zz.index])
        zz.detailarr.zhaolingpic = 'http://192.168.43.126:3000/images/' + zz.detailarr.zhaolingpic
      })
